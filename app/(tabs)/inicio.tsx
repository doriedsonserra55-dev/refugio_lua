  ...
  return (
    <View style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.landingContent} showsVerticalScrollIndicator={false}>
        ...
        <Pressable accessibilityRole="button" onPress={() => router.push("/institucional" as never)} style={({ pressed }) => [styles.institutionalLink, pressed && styles.pressed]}>
          <MaterialCommunityIcons name="information-outline" size={18} color="#2F6F8F" />
          <Text style={styles.institutionalLinkText}>Institucional · Sobre, Privacidade e Termos</Text>
          <MaterialCommunityIcons name="chevron-right" size={18} color="#2F6F8F" />
        </Pressable>
      </ScrollView>
    </View>
  );
